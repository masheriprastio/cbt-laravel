...
<div class="bg-white p-6 rounded-lg shadow-lg max-w-2xl">
  <form method="POST" action="{{ route('admin.users.update', $user) }}">
    ...
    <div class="mb-4">
      ...
      <input type="email" name="email" id="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ $user->email }}">
