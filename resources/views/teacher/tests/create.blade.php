...
<x-app-layout>
  <x-slot name="header"><h2 class="font-semibold text-xl">Buat Ujian</h2></x-slot>
    ...
    <form method="POST" action="{{ route('teacher.tests.store') }}" class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" name="duration_minutes" value="30" min="5" class="w-full border rounded-lg p-2" />
        </div>
